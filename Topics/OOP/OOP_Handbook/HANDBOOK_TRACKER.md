...
- **Four Pillars of OOP** — Chapter 1, §1.8 (preview); all four fully covered: Encapsulation (Ch. 12), Inheritance (Ch. 15), Polymorphism (Ch. 16), Abstraction (Ch. 17, extended by interfaces in Ch. 18). "Favor composition over inheritance" — mentioned here and in Ch. 15 §10 — now fully justified in Ch. 22 §6.
