...
- **Programming paradigm evolution** (Machine → Assembly → High-Level → Procedural → Modular → OOP) — Chapter 1, §1.1–1.4. (Packages as Modular Programming's Java mechanism specifically — Ch. 1 §1.4, now made mechanically precise by Ch. 14.)
